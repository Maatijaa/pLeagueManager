...
public enum Lang {
  ...
  INCORRECT_USAGE("incorrect-usage", String.join(System.lineSeparator(),
  ...
  RESULT_OVER("result.over", String.join(System.lineSeparator(),
      ...
      "&6▎ &f  Rezultat: &f{2} &e{3} &f- &e{4} &f{5}",
      "&6▎ &r")),
  RESULT_COINFLIP_MESSAGE("result.coinflip.broadcast", String.join(System.lineSeparator(),
      "&6▎ &r",
      "&6▎ &rZapočinje &eCoinFlip &fza loptu između timova {0} &fi {1}&f!",
      "&6▎ &rMolimo &ckapitene &ftimova da napišu &eheads &fili &etails &fu &6/&emsg &fsudiji!",
      "&6▎ &r")),
  RESULT_COINFLIP_SET("result.coinflip.set", "{prefix_success}Postavili ste {0} za tim {1}."),
  RESULT_COINFLIP_WINNER("result.coinflip.winner", String.join(System.lineSeparator(),
      "&6▎ &r",
      "&6▎ &eCoinFlip &fje pao na &e{0}&f!",
      "&6▎ &fTim {1} &fima loptu i započinje utakmicu!",
      "&6▎ &r")),
